...
export default function NewProjectPage() {
  ...
  if (!user || !["SUPER_ADMIN", "SALES"].includes(user.role)) return <div className="container py-12 text-center text-destructive">You do not have permission to create projects.</div>;
