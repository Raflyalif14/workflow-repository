...
assert(notificationOutboxMigration.includes('unique (output_document_id, version_id, event_status, recipient_user_id)'));
console.log('Test 12 - Output actions retain activity timeline events and durable deep-linked notification dispatch: passed');
